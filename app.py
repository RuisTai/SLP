...
if st.button("Predict Stress Level"):
    ...
    if snoring_rate == 0 or limb_movement == 0 or eye_movement == 0:
        incomplete_data_warning = (
            "<span style='color:blue'>Note: Some of the input variables (Snoring Rate, Limb Movement, Eye Movement) were not provided or are zero.</span>"
            "<span style='color:blue'>The prediction may not be highly accurate due to incomplete data.)</span>"
        )
